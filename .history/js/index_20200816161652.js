new Vue({
    ...
    computed: {
        ...
        widthOverallSize: function(){
            return this.width + (this.clearance * 10 * 2) + (this.materialThickness * numberOfLayerBySurface * 2)
        },
        depthOverallSize: function(){
            return this.depth + (this.clearance * 10 * 2) + (this.materialThickness * numberOfLayerBySurface * 2)
        },
        heightOverallSize: function(){
            return this.height + (this.clearance * 10) + (this.materialThickness * numberOfLayerBySurface * 2)
        }
    }
});