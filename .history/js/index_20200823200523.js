new Vue({
  ...
  computed: {
    ...
    editedWidthOverallSize: function () {
      return this.edit(this.widthOverallSize);
    },
    editedDepthOverallSize: function () {
      return this.edit(this.depthOverallSize);
    },
    editedHeightOverallSize: function () {
      return this.edit(this.heightOverallSize);
    },
  },
  methods: {
